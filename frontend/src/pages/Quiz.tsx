...
const Quiz = () => {
  ...
  }, [moduleId, isAuthenticated, setShowAuthModal]);
...
//   const handleAnswerSelect = (option: string) => {
//     const questionId =
//       questions[currentQuestionIndex]._id || questions[currentQuestionIndex].id;
//     setSelectedAnswers({
//       ...selectedAnswers,
//       [questionId]: option,
//     });

//     // Requirement: Automatically move to next question
//     setTimeout(() => {
...
//     try {
//       // Need to format answers as expected by backend
//       // Assuming backend expects { moduleId: string, answers: { questionId: string, selectedOption: string }[] }
...
//       <main className="flex-grow pt-32 pb-20 px-6 lg:px-20 relative overflow-hidden">
//         {/* Decorative elements based on inspiration */}
//         <div className="absolute top-20 left-10 opacity-10 hidden lg:block">
//           <FaQuestionCircle size={100} className="text-primary rotate-12" />
//         </div>
//         <div className="absolute bottom-20 right-10 opacity-10 hidden lg:block">
